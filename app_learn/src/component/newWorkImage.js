...
export default class SwiperDemo extends Component {
    ...
    render() {
        ...
        const loadViewBg = this.props.loadViewBg != null?this.props.loadViewBg:'rgba(0,0,0,.0)';
        return (
            <View>
                <Image onLoad={this.loadHandle.bind(this)} source={{uri:this.props.uri}} style={{width:this.props.width,height:this.props.height}}>
                    ...
                    {this.state.loading && <View style={[styles.loadingView,{backgroundColor:loadViewBg}]}>

                        {
                            ...
                            <Image style={[styles.loadingImage,{width:this.props.width,height:this.props.height,resizeMode:resizeMode}]} source={this.props.placeholder.uri}/>
