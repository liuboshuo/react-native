        ...
        return(
            ...
            <View style={styles.containerStyle}>
                ...
                <View style={styles.navViewStyle}>
                    ...
                    <TouchableOpacity style={styles.leftBtnStyle}>
                        <Image source={{uri:"icon_shop_local"}} style={styles.rightViewInnerImgStyle}/>
                    </TouchableOpacity>

                    <Text style={styles.middleTextStyle}>商家</Text>

                    <TouchableOpacity style={styles.rightBtnStyle}>
                        <Image source={{uri:"icon_shop_search"}} style={styles.rightViewInnerImgStyle}/>
                    </TouchableOpacity>
                </View>
